...
<head>
  ...
  <link rel="icon" href="D:\Site\Skin\logos/logohd.png">
  <link rel="stylesheet" href="D:\Site\Skin\styles.css">
</head>

<body>
  <header>
    <h1 align="center">
      <a href="D:\Site/Index.html"><img width="80px" height="30px" src="D:\Site\Skin\logos/logohc.png"></a>SKIN CARE<br>
      <font size="4" color="brown">SOLUÇÕES PARA A SUA PELE</font>
      <nav>
        <ul>
          <li><a href="D:\Site/Index.html">INÍCIO</a></li>
    ...
    <fieldset class="form-textarea">
      ...
      <div class="form-group">
        <button class="botao" type="reset" name="reset" id="reset">Limpar</button>
